...
<body>
        ...
        if (isset($data['newOtdel_name'])) {
            ...
            if (empty($errors)) {
                if ($count_otd) {
                    ...
                    echo '<div style="color: green; ">Отделение успешно изменено! Можно вернуться на <a href="/www/intro.php" data-ajax="1">главную</a>.</div><hr>';
    ...
    <main>
                      ...
                      <div class="col-6 ">
                          <h4><?php echo $otd['name'] ?>
                              <?php if (isset($_SESSION["auth"])) : ?>
                                  <a href="/www/otdelDelete.php?delOtdel_id=<?php echo $otd['id']; ?>" class="btn fa fa-trash" data-ajax="1" style="color:blue;"></a>
                                  <a href="/www/otdelCorrect.php?correctOtdel_id=<?php echo $otd['id']; ?>" class="btn fa fa-cog" data-ajax="1" style="color:blue;"></a>
                              <?php endif; ?>
                          </h4>
      ...
      <div class="container mt-5">
          ...
          <br>
          <p>Вернуться в раздел <a href="/www/otdel.php" data-ajax="1">отделения</a>.</p>
      </div>
